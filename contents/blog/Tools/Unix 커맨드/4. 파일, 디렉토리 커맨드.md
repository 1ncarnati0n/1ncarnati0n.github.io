...
`cd path/to/foo    (foo 디렉토리로 이동) cd path/to/bar    (bar 디렉토리로 이동) cd -              (다시 foo 디렉토리로 이동)`
...
vim 텍스트 에디터를 실행합니다. 이 [레슨](https://www.codeit.kr/topics/practical-unix-commands/lessons/4911)을 참고하세요.
