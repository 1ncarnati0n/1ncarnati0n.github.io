...
즉 $s_2$의 가치(밸류)를 평가해야 하는 방법은 *리턴의* **기댓값**<sup>Expectation</sup>을 사용하는 것이다.
...
>\ \ \
>P^{a_{1}}_{s_{2}, s_1} = 0.7
>$$

위 처럼 MDP가 간단하다면 최적 행동 하나만을 선택하면 되기에 최적 전략을 찾기 쉬우나 <br>아래와 같이 복잡해진다면 최적 행동을 찾는 것이 쉽지만은 않다.
