    ...
    <div className="max-w-4xl mx-auto px-6 py-20 space-y-20">
      ...
      <section>
        ...
        <div className="flex gap-4 items-center flex-wrap">
          <Button href="/blog" size="md">Blog</Button>
          <Button href="/works" size="md">Works</Button>
      ...
      <section>
        ...
        <div className="space-y-6">
          ...
          <div className="p-8 border border-neutral-200 dark:border-neutral-800 rounded-lg text-center">
            ...
            <p className="text-neutral-500 text-sm mb-6">찾는 페이지가 없습니다.</p>
            <Button href="/" size="lg">홈으로 돌아가기</Button>
          </div>
